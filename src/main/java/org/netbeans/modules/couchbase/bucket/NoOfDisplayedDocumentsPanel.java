...
@TopComponent.Description(
        preferredID = "NoOfDisplayedDocumentsPanel",
        iconBase = "org/netbeans/modules/couchbase/database.png",
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "navigator", openAtStartup = false)
public class NoOfDisplayedDocumentsPanel extends ObjectTopComponent implements ActionListener {

    private Bucket bucket;

    public NoOfDisplayedDocumentsPanel() {
    }

    public NoOfDisplayedDocumentsPanel(final Bucket bucket) {
        this.bucket = bucket;
